...
// Validate ../../../app/api/proyectos/[id]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/proyectos/[id]">> = Specific
  const handler = {} as typeof import("../../../app/api/proyectos/[id]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
